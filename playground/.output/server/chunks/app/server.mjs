...
const ___node_modules_nuxt_dist_head_runtime_plugin_mjs_lXdWSY5p6G = defineNuxtPlugin((nuxtApp) => {
...
class UnleashFlags {
  constructor(features, config, context) {
  ...
  isAllowIP(name) {
    ...
    if (!feature || !(feature == null ? void 0 : feature.enabled) || !strategies) {
      return false;
    }
    for (const strategy of strategies) {
      const ips = strategy.parameters.userIds.split(",").map((s) => s.trim());
      if (this.context.ip !== void 0 && this.context.ip.length > 0 && ips.includes(this.context.ip)) {
        return true;
      }
    }
    return false;
  ...
  isAllowUser(name, user) {
    ...
    for (const strategy of strategies) {
      const users = strategy.parameters.userIds.split(",").map((s) => s.trim());
  ...
  getFeature(name, strategyName = "userWithId") {
...
const _nuxt_runtime_plugin_cefeb87c_ts_2307sNO21k = defineNuxtPlugin((nuxtApp) => {
  const FEATURES = JSON.parse('[{"name":"maintenance","description":"Mantenimiento de la p\xE1gina","enabled":false,"strategies":[{"name":"default","parameters":{}}]},{"name":"cancel-subscription","description":"Nueva feature cancelaci\xF3n con endpoint","enabled":false,"strategies":[{"name":"default","parameters":{}}]},{"name":"debug-logs","description":"","enabled":true,"strategies":[{"name":"userWithId","parameters":{"userIds":"85.58.231.181,7b388f81-3b3d-4b24-9a93-4881c1a0bb6a"}}]},{"name":"disable-logs","description":"Disable logs temp","enabled":false,"strategies":[{"name":"default","parameters":{}}]},{"name":"detail-subscription","description":"Detalle de suscripci\xF3n de un usuario","enabled":true,"strategies":[{"name":"default","parameters":{}}]},{"name":"handbook-creator","description":"Feature del manual del creador","enabled":true,"strategies":[{"name":"default","parameters":{}}]}]');
...
const _plugins = [
  ...
  ___node_modules_nuxt_dist_head_runtime_plugin_mjs_lXdWSY5p6G,
  ___node_modules_nuxt_dist_app_plugins_router_mjs_ImrxePpayI,
  _nuxt_runtime_plugin_cefeb87c_ts_2307sNO21k
];
const _sfc_main$1 = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./_nuxt/error-component.f7dcb1af.mjs'));
    const nuxtApp = useNuxtApp();
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>${serverRenderer.exports.ssrInterpolate(_ctx.$unleash())}</div>`);
}
